...
module.exports = function(pth, url) {
	...
	return function* (next) {
		...
		this.redirect = function(ipath, alt) {
			redirect.call(this, ipath + (this.query.format ? '?format=' + this.query.format : ''), alt);
		};
